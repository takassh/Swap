...
contract V2Swap {
    ...
    function swapExactInputSingle(uint256 amountIn, address from, address to)
        external
    ...
    function swapExactOutputSingle(uint256 amountOut, uint256 amountInMaximum, address from, address to)
        external
